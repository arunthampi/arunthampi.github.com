---
layout: post
title: Path uploads your entire iPhone address book to it's servers
---
...
<ol>
  <li>Downloads the <a href="http://mitmproxy.org/">mitmproxy</a> tool and set it up by going to the folder of mitmproxy and running <code>sudo python setup.py install</code>. If all goes well, mitmproxy must be available in your $PATH.</li>
